    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-72 bg-black/40 border-r border-primary-border flex flex-col pt-8">
            ...
            <nav class="flex-1 px-4 space-y-1">
                ...
                <a href="{{ route('admin.monitoring.index') }}" class="flex items-center gap-4 px-6 py-4 rounded-xl transition-all {{ request()->routeIs('admin.monitoring.*') ? 'sidebar-active' : 'text-on-variant hover:bg-white/5' }}">
