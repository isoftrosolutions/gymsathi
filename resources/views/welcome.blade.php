...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>GymSathi — Kinetic Gym Management for Nepal</title>
    ...
    <body>
        ...
        <nav class="navbar">
            <div class="container nav-content">
                <a href="{{ route('welcome') }}" class="logo">GYM<span>SATHI</span></a>
                <div class="nav-links">
                ...
                <a href="#pricing" class="btn btn-primary" style="padding: 0.8rem 1.5rem; font-size: 0.8rem;">Start Free Trial</a>
            </div>
        </nav>
        ...
        <!-- Footer -->
        <footer class="section-padding" style="padding-bottom: var(--space-md);">
            <div class="container">
                <div class="footer-content">
                    <div style="max-width: 300px;">
                        <a href="{{ route('welcome') }}" class="logo">GYM<span>SATHI</span></a>
                        <p style="color: var(--on-surface-variant); font-size: 0.9rem; margin-top: 1rem;">Built locally in Nepal for the high-performance gym owner. From Birgunj to the world.</p>
                    </div>
                    <div>
                        <p style="font-weight: 800; margin-bottom: 1rem;">CONTACT</p>
                        <p style="color: var(--on-surface-variant);">WhatsApp: +977 9800000000</p>
                        <p style="color: var(--on-surface-variant);">Email: sathi@isoftro.com</p>
                    </div>
                    <div>
                        <p style="font-weight: 800; margin-bottom: 1rem;">SOCIAL</p>
                        <a href="#" style="color: var(--on-surface-variant); text-decoration: none;">Facebook</a><br>
                        <a href="#" style="color: var(--on-surface-variant); text-decoration: none;">Instagram</a>
                    </div>
                </div>
                <div class="footer-bottom">
                    &copy; 2026 iSoftro Solutions. All Rights Reserved.
                </div>
            </div>
        </footer>
    </body>
